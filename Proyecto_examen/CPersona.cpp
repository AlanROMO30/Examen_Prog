...
void CPersona::setCIMC()
{
	...
	else if ((m_IMC < 17.5) && (m_sexo == 'F'))
	{
		cout << "BAJO";
		m_calcIMC = 1;
	}
	else if ((m_IMC <= 23.9) && (m_sexo == 'F')) {
		cout << " NORMAL";
		m_calcIMC = 2;
	}
	else if ((m_IMC <= 28.9) && (m_sexo == 'F')) {
		cout << " SOBREPESO ";
		m_calcIMC = 3;
	}
	else if ((m_IMC <= 33.9) && (m_sexo == 'F')) {
		cout << " OBESIDAD I ";
		m_calcIMC = 4;
	}
	else if ((m_IMC <= 38.9) && (m_sexo == 'F')) {
		cout << " OBESIDAD II ";
		m_calcIMC = 5;
	}
	else if ((m_IMC >= 39) && (m_sexo == 'F')) {
		cout << " OBESIDAD III ";
		m_calcIMC = 6;
	}
    else {
